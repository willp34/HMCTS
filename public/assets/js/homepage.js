        ...
        columns: [
            ...
            { title: "TimeStamp", data: 'created_at' },
            {
                ...
                render: function (data) {
                    return `<button class="btn btn-primary taskAction" data-bs-toggle="modal" data-bs-target="#taskModal" data-action="Put">Edit</button>`;
                }
            },
            {
...
// Convert serialized data to JSON
			   ...
			   let table = jQuery('#hmct_data_table').DataTable(); // Use your actual table ID
				  table.row.add({
					...
					created_at:response.data.created_at,
					  actions: `'<button class="btn btn-primary taskAction" datadata-bs--toggle="modal" datadata-bs--target="#taskModal" data-action="Put">Edit</button>',
    ...
    function handleDeleteAction( rowElement) {
        ...
        handleAjaxRequest("GET", "http://localhost/HMCTS/public/index.php/api/deleteTask/"+rowData[0], null, true, function (response) {
