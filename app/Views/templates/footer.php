		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
								...
								<form class="process_edit"  action ="<?php echo base_url()?>index.php/api/editTask" method="post"   >
							<fieldset>
...
<script type="text/javascript"  src="http://localhost/HMCTS/public/assets/js/jquery/jquery.min.js"  > </script>
<script type="text/javascript"  src="http://localhost/HMCTS/public/assets/js/datatables.min.js"  > </script>

<!-- Bootstrap 5 JavaScript Bundle (includes Popper.js) -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js"></script>
<script type="text/javascript"  src="http://localhost/HMCTS/public/assets/js/homepage.js"  > </script>
</html>